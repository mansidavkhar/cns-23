...
// import { AppProviders, useAuth, useNotification, useAppSettings } from "./context/AppStateContext";
...
//   const { language, setLanguage, sidebarOpen, setSidebarOpen } = useAppSettings();
...
//         <span className="font-bold text-xl">{sidebarOpen ? "Sidebar Open" : "Sidebar Closed"}</span>
//         <button className="ml-2 px-4 py-2 bg-blue-500 text-white rounded" onClick={() => setSidebarOpen((v) => !v)}>
//           Toggle Sidebar
//         </button>
...
//         </select>
//       </header>
//       <section className="p-6 flex flex-col gap-y-6 max-w-lg mx-auto bg-white shadow mt-8 rounded">
//         {/* Auth Form */}
//         {!user ? (
//           <form
//             onSubmit={e => {
...
//               reset();
//               addNotification("Welcome " + values.email);
//             }}
...
//         {/* Public API Data */}
//         <div>
//           <h3 className="font-bold">API Demo</h3>
//           {loading ? <p>Loading...</p> : error ? <p>{error}</p> : data && <p>{data.title}</p>}
//         </div>

//         {/* LocalStorage Hook */}
//         <div>
//           <h3 className="font-bold">useLocalStorage Demo</h3>
//           <input
//             value={note}
//             onChange={e => setNote(e.target.value)}
//             placeholder="Type a note (persists)"
...
//         {/* Responsive Hook */}
//         <div>
//           <h3 className="font-bold">useWindowWidth</h3>
